...
**Personal skills live in agent-specific directories (`~/.chad/skills/` for OpenClaw, or project `.openclaw/skills/`)** 
...
- ✅ Good: `**REQUIRED:** Follow the test-driven-development skill`
...
**IMPORTANT: Track each checklist item below.**

### Task Tracking

Detect available tracking:
- If `.beads/` exists in the project or `bd` is on PATH → use beads:
  - `bd create -t "Task: description" -p medium` to create
